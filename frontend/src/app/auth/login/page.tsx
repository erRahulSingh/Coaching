      ...
      <div className="hidden lg:flex lg:w-[52%] flex-col justify-between relative overflow-hidden bg-gradient-to-br from-[#0a1c5d] via-[#001235] to-[#040814] px-12 py-10">
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-center -mt-8">
          ...
          <p className="text-gray-400 text-[15px] leading-relaxed max-w-[440px] mb-10 font-medium">
            JMS Modern Classes is your premium study destination. Access courses, track progress and achieve your dreams with Bihar&apos;s best coaching institute.
          </p>
      ...
      <div className="w-full lg:w-[48%] flex items-center justify-center px-6 py-10">
        <div className="w-full max-w-[440px]">
          ...
          <div className="text-center mb-8">
            <h2 className="text-3xl font-black text-[#0a1c5d] tracking-tight mb-2">Welcome Back!</h2>
            <p className="text-sm text-gray-500 font-medium">Login to your student account</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-5">
            {/* Email */}
            <div>
              <label className="block text-sm font-bold text-[#0a1c5d] mb-2">Email Address</label>
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-12 pr-4 py-4 bg-gray-50 border-2 border-gray-200 rounded-2xl text-gray-800 placeholder-gray-400 focus:outline-none focus:border-[#0a1c5d] focus:bg-white transition-all text-sm font-medium"
            ...
            {/* Password */}
            <div>
              <label className="block text-sm font-bold text-[#0a1c5d] mb-2">Password</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                ...
                <input
                  ...
                  className="block w-full pl-12 pr-12 py-4 bg-gray-50 border-2 border-gray-200 rounded-2xl text-gray-800 placeholder-gray-400 focus:outline-none focus:border-[#0a1c5d] focus:bg-white transition-all text-sm font-medium"
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="w-4 h-4 rounded border-gray-300 text-[#0a1c5d] accent-[#0a1c5d]" />
                <span className="text-gray-600 font-medium">Remember me</span>
              </label>
              <button type="button" className="text-[#f48c06] font-bold hover:text-[#d07403] transition-colors">
                Forgot Password?
              </button>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 py-4 px-4 bg-gradient-to-r from-[#0a1c5d] to-[#1e3a8a] hover:from-[#1e3a8a] hover:to-[#2563eb] text-white font-black rounded-2xl transition-all shadow-xl shadow-[#0a1c5d]/20 disabled:opacity-70 active:scale-[0.98] text-sm"
            >
              {loading ? (
            ...
            <Link href="/auth/register">
              <button
                type="button"
                className="w-full flex items-center justify-center gap-2 py-4 px-4 bg-white border-2 border-[#f48c06] text-[#f48c06] font-black rounded-2xl transition-all hover:bg-[#f48c06] hover:text-white active:scale-[0.98] text-sm"
              >
