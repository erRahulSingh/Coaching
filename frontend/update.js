...
// We know from view_file that the topper section ends around line 702
// specifically:
// 701:         </div>
// 702:       </section>
// We will slice up to the end of the Topper section.
let endOfTopper = 0;
...
if (endOfTopper === 0) {
  console.log("Could not find topper section");
  process.exit(1);
}
